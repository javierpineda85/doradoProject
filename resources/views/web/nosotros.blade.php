            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-offset-3 col-md-6 col-sm-offset-2 col-sm-8 ">
                    <div class="header-thumb">
                        <h1 class="wow fadeIn" data-wow-delay="0.3s">Nosotros</h1>
                        <!--<h3 class="wow fadeInUp" data-wow-delay="0.9s">Sabemos que puerta vas a elegir</h3> -->
                    </div>
                </div>
    ...
    <section id="about">
        <div class="container">
            <div class="row">
                ...
                <div class="wow fadeInUp col-md-4 col-sm-5" data-wow-delay="0.5s">
