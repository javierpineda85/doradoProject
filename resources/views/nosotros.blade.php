        ...
        <div class="container">
            <div class="row">
                ...
                <div class="wow fadeInUp col-md-7 col-sm-7" data-wow-delay="1.6s">
                    ...
                    <br>La tarea implica una propuesta individual ajustando las exigencias del entorno social y mediando con las redes de este entorno para fortacer espacios adaptados que favorezcan la inclusión. Dorado no solo trabaja trabaja puertas adentro, trabaja y trabaja mucho puertas afuera...
                ...
                <div class="wow fadeInUp col-md-4 col-sm-6" data-wow-delay="0.4s">
                    <h1>PSICOLOGÍA</h1>
                    <p>Desde una corriente neuropsicologica, evalúa y define el perfil para aplicar programas de rehabilitación, estimulación cognitiva,desarrollo de habilidades sociales y emocionales. 
                ...
                <div class="wow fadeInUp col-md-4 col-sm-6" data-wow-delay="0.8s">
                    <h1>FONOAUDIOLOGÍA Y TERAPIA DEL LENGUAJE</h1>
                    <p>Desde una corriente neurolingüística, las especialistas del habla, lenguaje y comunicación buscan favorecer los espacios y entor os comunicativos adaptados e inclusivo. El objetivo principal se basa en establecer relaciones interpersonales con un encuadre comunicativo eficaz independientemente del canal, código o características del emisor y/o receptor.</p>
                </div>
                ...
                <div class="wow fadeInUp col-md-6 col-sm-6" data-wow-delay="1.4s">
                    <h1>KINESIOLOGÍA</h1>
                    <p>Rehabilitacion motora con enfoque integral orientado a mejorar la postura y la movilidad del paciente y a aumentar su autonomia en transferencias y traslados a traves de movilizaciones pasivas y activas, ejercitacion activa de diferentes grupos musculares en un espacio lúdico, combinado con aplicacion de taping neuromuscular y utilizacion de electroterapia.
Este área se combina con la ASISTENCIA SOCIAL para favorecer las adaptaciones de los entornos pensados desde el DU (diseño universal). Se complementa con los talleres de turismo aventura, acrobacia aérea en tela y terapias asistida con animales en donde extiende la propuesta al aumento radical de la motivación e intereses de los participantes.</p>
                </div>
