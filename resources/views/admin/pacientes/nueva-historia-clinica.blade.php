    ...
    <form class="needs-validation" novalidate>
        ...
        <div class="form-row"> <!-- Nombres y apellidos -->
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="validationTooltip01" placeholder="Nombres" value="" required>
        ...
        <div class="form-row">  <!-- Diagnostico Clinico / Foto perfil -->
            <div class="col-md-8 mb-3">
                ...
                <input type="text" class="form-control" id="validationTooltip02" placeholder="Diagnóstico" value="" required>
                <div class="valid-tooltip">
                    Correcto!
                </div>
            </div>
    ...
    <!-- DATOS OBRA SOCIAL -->
        ...
        <div class="form-row"> <!-- obra social / nº afiliado -->
            <div class="col-md-8 mb-2">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="validationTooltipUsername" placeholder="Nombre Obra Social" aria-describedby="validationTooltipUsernamePrepend" required>
                    <div class="invalid-tooltip">
                        Por favor no te olvides de completar aquí.
                    </div>
                </div>
